...
func init() {
	...
	// TODO(dan) Are we using these now?
	opsee_types.PermissionsRegistry.Register("team_flags", opsee_types.NewPermissionsBitmap("multi_user", "multi_bastion", "on_site_support"))
}
