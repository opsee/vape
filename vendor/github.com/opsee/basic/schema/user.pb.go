...
type User struct {
	...
	Perms        *opsee_types3.Permission `protobuf:"bytes,13,opt,name=perms" json:"perms,omitempty" token:"perms" db:"perms"`
	HasPassword  bool                     `protobuf:"varint,14,opt,name=has_password,json=hasPassword,proto3" json:"has_password"`
	TeamFlags    *opsee_types3.Permission `protobuf:"bytes,15,opt,name=team_flags,json=teamFlags" json:"team_flags,omitempty" token:"team_flags"`
}
...
func (m *User) GetTeamFlags() *opsee_types3.Permission {
	if m != nil {
		return m.TeamFlags
	}
	return nil
...
func (this *User) Equal(that interface{}) bool {
	...
	if !this.TeamFlags.Equal(that1.TeamFlags) {
		return false
	}
	return true
}
	...
	GraphQLUserType = github_com_graphql_go_graphql.NewObject(github_com_graphql_go_graphql.ObjectConfig{
		...
		Fields: (github_com_graphql_go_graphql.FieldsThunk)(func() github_com_graphql_go_graphql.Fields {
			return github_com_graphql_go_graphql.Fields{
				...
				"team_flags": &github_com_graphql_go_graphql.Field{
					Type:        github_com_opsee_protobuf_plugin_graphql_scalars.Permission,
					Description: "",
					Resolve: func(p github_com_graphql_go_graphql.ResolveParams) (interface{}, error) {
						obj, ok := p.Source.(*User)
						if ok {
							if obj.TeamFlags == nil {
								return nil, nil
							}
							return obj.GetTeamFlags(), nil
						}
						inter, ok := p.Source.(UserGetter)
						if ok {
							face := inter.GetUser()
							...
							if face.TeamFlags == nil {
								return nil, nil
							}
							return face.GetTeamFlags(), nil
						}
						return nil, fmt.Errorf("field team_flags not resolved")
					},
				},
			}
		}),
...
func (m *User) MarshalTo(data []byte) (int, error) {
	...
	if m.TeamFlags != nil {
		data[i] = 0x7a
		i++
		i = encodeVarintUser(data, i, uint64(m.TeamFlags.Size()))
		n4, err := m.TeamFlags.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *Invite) MarshalTo(data []byte) (int, error) {
	...
	if m.Perms != nil {
		...
		i++
		i = encodeVarintUser(data, i, uint64(m.Perms.Size()))
		n9, err := m.Perms.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func NewPopulatedUser(r randyUser, easy bool) *User {
	...
	if r.Intn(10) != 0 {
		this.TeamFlags = opsee_types3.NewPopulatedPermission(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (m *User) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TeamFlags", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TeamFlags == nil {
				m.TeamFlags = &opsee_types3.Permission{}
			}
			if err := m.TeamFlags.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorUser = []byte{
	...
	,
}
